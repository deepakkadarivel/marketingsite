...
import News_Opinion_We_Cant_Become from '../../assets/images/news/News_Opinion_We_Cant_Become.jpg';
...
import News_Zinc_Goes_Home from '../../assets/images/news/News_Zinc_Goes_Home.jpg';

let brakePoints = [750];
const newsImages = [
  {
    img: News_Opinion_We_Cant_Become,
    heading:
      'OPINION: WE CAN’T BE- COME A NATION OF EQUAL LEARNERS UNTIL WE BECOME A NATION OF READERS',
    date: 'June 4, 2018',
    description:
      'How to level the literacy play- ing field, at last \n espite the claims of those who propose to “disrupt” educa- tion with video lessons and a well-intentioned emphasis on STEM, reading remains the backbone of a real education. \n Unlike other species, humans use language as a kind of oper- ating system for our big brains. Our intellectual abilities evolved in concert with our linguistic abilities. \n Words act as handles that al- low our minds to manipulate ideas, and written language in- vents syntaxes that go far be- yond anything in spoken com- munication. \n That’s why advanced reading correlates so highly with crit- ical thinking skills. Mastering advanced syntax allows our brains to work on a higher level. When we read Charles Darwin, George Eliot, Stephen J. Gould or Toni Morrison, what they say increases our knowledge, but how they say it makes us smarter. For rapidly developing adolescent brains, engagement with great minds through their words activates deeper cognitive abilities.',
    link:
      'https://hechingerreport.org/opinion-we-cant-become-a-nation-of-equal-learners-until-we-become-a-nation-of-readers/'
  },
  {
  ...
  {
    img: News_Zinc_Goes_Home,
    heading: 'ZINC GOES HOME',
    date: 'November 15, 2016',
    description:
      'Zinc strives to support learners in all environments, so as more and more families are deciding to homeschool, we’re adapt- ing to meet these users’ unique needs. We’re getting great feedback on how our diverse offerings complement what ho- meschooling parents have in place and help to prep students for standardized exams, like the SAT and ACT. And with our leaderboard showing all Zinc users, homeschool students get to benefit from the healthy competition that our students in traditional classrooms experience. \n Cathy Duffy, the renowned ho- meschool curriculum specialist and author of Christian Home Educators’ Curriculum Manual weighed in on Zinc on her site. Read her full review',
    link:
      'https://cathyduffyreviews.com/homeschool-reviews-core-curricula/phonics-reading/reading-skills-supplements/zinc-reading-labs-online'
  },
  {
